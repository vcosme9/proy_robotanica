...
class FollowThroughWaypoints(Node):
    ...
    def __init__(self):
        ...
        #tipo de mensaje
        #nombre de la accion
        self._action_client = ActionClient(self, FollowWaypoints, 'navigate_to_pose')
...
def main(args=None):
    ...
    action_client = FollowThroughWaypoints(goal_poses)
